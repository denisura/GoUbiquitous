...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private void updateWearable(ContentValues values) {
        ...
        double highTemp = values.getAsDouble(WeatherContract.WeatherEntry.COLUMN_MAX_TEMP);
        double lowTemp = values.getAsDouble(WeatherContract.WeatherEntry.COLUMN_MIN_TEMP);
        WatchFaceUtil.setWeatherInfo(client, weatherId, highTemp, lowTemp);
    }
